prayer_accompA_notes_only = \compressMMRests \relative c' {
  \prayerGlobal
  \clef "bass"
  r4
  \clef "tenor"
  ...
  c2-- bf-- | % bar# 9
  g1 | % bar# 10
  f2~f8 r \tuplet 3/2 {f8( g af)} | % bar# 11
  ...
  af2~^"a tempo" af8 c( bf af) | % bar# 18
  \tuplet 3/2 { g--( f ef~ } ef4) r8 \clef "bass" ef( af[ bf]) | % bar# 19
  { \tuplet 3/2 { c(df c }
    bf8 af)
  ...
  f'2.-- f8( ef) | % bar# 48
  df2-- f-- | % bar# 49
  <c af>2 r4 af8--(bf) | % bar# 50
  g2. r4 | % bar# 51
  f4.( g8 af bf) f( g | % bar# 52
  { af8 bf)
    \tuplet 3/2 4 { f8( g af bf c df) }
    \acciaccatura{df16 ef} \tuplet 3/2 { df8( c bf) }
  } | % bar# 53
  c4f2-- \tuplet 3/2 { ef8 df c } | % bar# 54
  bf2~bf8 r ef,8.( ef'16) | % bar# 55
  ef2 df | % bar# 56
  g,1 | % bar# 57
  f2~ f~ | % bar# 58
  \tempo "Più vivo"
