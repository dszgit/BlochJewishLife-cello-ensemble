supplication_accompD_notes_only =  \transpose g \supplicationKey \compressMMRests \relative c' {
  \supplicationGlobal
  \clef "bass"
  R2*2 | % bar# 1-2
  \clef "tenor"
  ...
  \tuplet 3/2 4 { b'8-0(e,-0 b'-0 e,-0 b'-0 e,-0 } | | % bar# 3
  ...
  b8 b4 b8~ | % bar# 63
  b8b4 r8 | % bar# 64
  \acciaccatura{e,,8} e'8 e4 e8~ | % bar# 65
  e8 e,4 e'8~ | % bar# 66
  e8 e4 e8 | % bar# 67
  R2*3 | % bar# 68-70
  r8 r4 e,8~ | % bar# 71
