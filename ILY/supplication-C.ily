supplication_accompC = \transpose g \supplicationKey \compressMMRests \relative c' {
  \supplicationGlobal
  \bassToTenor
  ...
  \tuplet 3/2 4 { b'8-0(\p e,-0 b'-0 e,-0 b'-0 e,-0 } | % bar# 1
  ...
  R2 | % bar# 15
  \tuplet 3/2 4 { b8(^"poco rit." e b e b e,) } | % bar# 16
  \clef "bass"
  \tuplet 3/2 4 { e8(^"a tempo" b' e, b' e, b' } | % bar# 17
  ...
  g8--( fs4.) | % bar# 44
  e2~ | % bar# 45
  e2^\markup{\column{"poco a poco" "animando e cresc."}} | % bar# 46
  c'4. e8~ | % bar# 47
  e8 a,4( b8) | % bar# 48
  c8(\< e4) g8~-- | % bar# 49
  g4 a4-- | % bar# 50
  ...
  ds2~ | % bar# 63
  ds4.\p r8 | % bar# 64
  R2*3^\markup{\hspace #15 "a tempo (poco più lento)" } | % bar# 65-67
  r8 e,4 e'8~ | % bar# 68
  e8 e4 e,8~ | % bar# 69
  e8\pp e'4 e8~ | % bar# 70
  e8 e4 r8 | % bar# 71
